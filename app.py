# ==============================
# HandPD Streamlit App - Fully Cleaned
# ==============================
...
if uploaded_file is not None:
    ...
    # Rename columns if headers mismatch
    if list(spiral_df.columns) != expected_cols:
        st.warning("CSV headers mismatch. Fixing automatically...")
        spiral_df.columns = expected_cols

    # --- Step 3: Convert all numeric features to numbers ---
    ...
    if st.button("Predict"):
        ...
        new_sample_df = new_sample_df.apply(pd.to_numeric, errors='coerce').fillna(0)
    ...
    st.success("✅ App ready! Upload CSV, train model, and predict new samples.")
